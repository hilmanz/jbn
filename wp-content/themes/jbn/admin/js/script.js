jQuery(document).ready(function() {
    	...
    	jQuery('#upload_image_button_9').click(function(){
 		formfield = jQuery('#upload_image_9').attr('name');
 		tb_show('', 'media-upload.php?type=image&amp;TB_iframe=1');
 
		window.send_to_editor = function(html) {
 			imgurl = jQuery('img',html).attr('src');
 			jQuery('#upload_image_9').val(imgurl);
 			tb_remove();
		}
 
	 	return false;
	});
    	jQuery('#upload_image_button_10').click(function(){
 		formfield = jQuery('#upload_image_10').attr('name');
 		tb_show('', 'media-upload.php?type=image&amp;TB_iframe=1');
 
		window.send_to_editor = function(html) {
 			imgurl = jQuery('img',html).attr('src');
 			jQuery('#upload_image_10').val(imgurl);
 			tb_remove();
		}
 
	 	return false;
	});
    	jQuery('#upload_image_button_11').click(function(){
 		formfield = jQuery('#upload_image_11').attr('name');
 		tb_show('', 'media-upload.php?type=image&amp;TB_iframe=1');
 
		window.send_to_editor = function(html) {
 			imgurl = jQuery('img',html).attr('src');
 			jQuery('#upload_image_11').val(imgurl);
 			tb_remove();
		}
 
	 	return false;
	});
    	jQuery('#upload_image_button_12').click(function(){
 		formfield = jQuery('#upload_image_12').attr('name');
 		tb_show('', 'media-upload.php?type=image&amp;TB_iframe=1');
 
		window.send_to_editor = function(html) {
 			imgurl = jQuery('img',html).attr('src');
 			jQuery('#upload_image_12').val(imgurl);
 			tb_remove();
		}
 
	 	return false;
	});
    	jQuery('#upload_image_button_13').click(function(){
 		formfield = jQuery('#upload_image_13').attr('name');
 		tb_show('', 'media-upload.php?type=image&amp;TB_iframe=1');
 
		window.send_to_editor = function(html) {
 			imgurl = jQuery('img',html).attr('src');
 			jQuery('#upload_image_13').val(imgurl);
 			tb_remove();
		}
 
	 	return false;
	});
    	jQuery('#upload_image_button_14').click(function(){
 		formfield = jQuery('#upload_image_14').attr('name');
 		tb_show('', 'media-upload.php?type=image&amp;TB_iframe=1');
 
		window.send_to_editor = function(html) {
 			imgurl = jQuery('img',html).attr('src');
 			jQuery('#upload_image_14').val(imgurl);
 			tb_remove();
		}
