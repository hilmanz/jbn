...
function bootstrap_shortcodes_styles_all() {
    wp_register_style( 'bootstrap-shortcodes-help-all', get_bloginfo('template_directory').'/functions/includes/help/css/bootstrap-shortcodes-help-all.css' );
...
function bootstrap_shortcodes_help_styles() {
        wp_register_style( 'bs-font', get_bloginfo('template_directory').'/functions/includes/help/bs-font.css');
        wp_register_style( 'bootstrap-shortcodes-help', get_bloginfo('template_directory').'/functions/includes/help/css/bootstrap-shortcodes-help.css');
        wp_register_style( 'bootstrap-modal', get_bloginfo('template_directory').'/functions/includes/help/css/bootstrap-modal.css');
        wp_register_script( 'bootstrap', get_bloginfo('template_directory').'/functions/includes/help/js/bootstrap.min.js');
