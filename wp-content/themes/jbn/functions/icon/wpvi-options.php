...
function wpvi_toggle_font_callback($args) {
	...
	$html .= "<img src='".get_bloginfo('template_directory').'/functions/icon/img/fa-cover2.png'."' width='300' height='225' />";
	...
	// Genericons
	$html .= '<div class="available-theme">';
	$html .= "<img src='".get_bloginfo('template_directory').'/functions/icon/img/gen-cover2.png'."' width='300' height='225' />";
...
function wpvi_op_style() {
	wp_register_style( 'wpvi-ops', get_bloginfo('template_directory').'/functions/icon/css/wpvi-options.css', array(), array(), $media = 'all' );
